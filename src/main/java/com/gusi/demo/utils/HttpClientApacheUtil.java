...
import com.gusi.demo.mng.response.BaseResponse;

/**
 * HTTP请求客户端
 */
public final class HttpClientApacheUtil {
	 ...
	 * 日志输出组件
	 */
	private static final Logger LOG = LoggerFactory.getLogger(HttpClientApacheUtil.class);
	/**
	 * 字符集，统一使用UTF-8
	 */
